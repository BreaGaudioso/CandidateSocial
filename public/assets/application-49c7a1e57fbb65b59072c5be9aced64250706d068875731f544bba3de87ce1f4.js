...
//   .directive('allBars',allBars);

//   allBars.$inject = ['d3Factory', '$window'];

//   function allBars(d3Factory, $window){
//     return{
//       restrict: 'EA',
...
//                 toolTipText = (`${d.text} \ Retweets:${d.retweet_count} \ Favors: ${d.favorite_count}`) 
        ...
        .orient("left");
            ...
            var sets = svg.selectAll(".set") 
              ...
              .on("mouseover", function(d,i) {
                ...
                toolTipText = (`${d.candidate.name} \ ${d.text} \ Retweets:${d.favorite_count} \ Favors: ${d.retweet_count}`) 
...
(function(){
  ...
  angular
  .module('app.candidates')
  .directive('barstwo',barstwo);

  barstwo.$inject = ['d3Factory', '$window'];

  function barstwo(d3Factory, $window){
    return{
      restrict: 'EA',
      templateUrl : 'partials/doubleBar.html',
      scope: {
      ...
      link: function(scope, element, attrs){
        ...
        scope.render = function(data){
          ...
          console.log(scope.data);
          if (!data) return;
          var tdata = d3.transpose(data.favorite_count, data.retweet_count);
          var series = 2;
